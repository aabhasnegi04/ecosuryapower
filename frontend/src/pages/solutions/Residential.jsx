  ...
  return (
    <>
      <SEO 
        ...
        description="Lower electricity bills with premium residential solar solutions. Reliable backup power, smart monitoring, and 25-year life. Built for Indian rooftops."
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-12 md:divide-x md:divide-white/10">
              ...
              <div className="text-center observe">
                ...
                <div className="text-sm tracking-[0.2em] text-gray-400 uppercase">Electricity Goal</div>
              </div>

              <div className="text-center observe">
                <div className="text-4xl md:text-5xl font-bold mb-4 text-[#00D26A] tracking-tight whitespace-nowrap">25</div>
                <div className="text-sm tracking-[0.2em] text-gray-400 uppercase">Years Warranty</div>
              </div>
