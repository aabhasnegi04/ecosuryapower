          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-12 md:gap-20 lg:gap-24">
              ...
              <div className="text-center observe">
                <div className="text-5xl md:text-6xl lg:text-7xl font-bold mb-5 text-green-500 stat-number">3-in-1</div>
                <div className="text-xs md:text-sm uppercase tracking-[0.15em] text-zinc-400 opacity-70">Power Sources</div>
              </div>

              <div className="text-center observe">
                <div className="text-5xl md:text-6xl lg:text-7xl font-bold mb-5 text-green-500 stat-number">100%</div>
                <div className="text-xs md:text-sm uppercase tracking-[0.15em] text-zinc-400 opacity-70">Uptime Guarantee</div>
              </div>
