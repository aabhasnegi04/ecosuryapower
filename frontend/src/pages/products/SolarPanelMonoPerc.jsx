...
export default function SolarPanelMonoPerc() {
  return (
    <>
      <SEO 
      ...
      <div className="min-h-screen" style={{ backgroundColor: '#e4e8e8' }}>
      
      {/* 1. HERO */}
      <section className="relative min-h-screen flex items-center" style={{ backgroundColor: '#e4e8e8' }}>
      ...
      {/* 4. USE CASE */}
      <section className="relative py-32 md:py-40 overflow-hidden" style={{ backgroundColor: '#e4e8e8' }}>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="max-w-2xl">
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-[#0B0D10]">
              Built for Indian rooftops.<br />Not lab conditions.
            </h2>
            <div className="space-y-4 text-lg text-[#475063]">
              <p>✓ Residential rooftop installations</p>
              <p>✓ Commercial & industrial projects</p>
              <p>✓ Ground-mounted solar farms</p>
              <p>✓ Off-grid power systems</p>
            </div>
          </div>
        </div>
      </section>
