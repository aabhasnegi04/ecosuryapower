export default function SparkleHybridSolarInverters() {
  return (
    <div className="min-h-screen bg-white">
            ...
            <div className="grid md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
              ...
              <div>
                ...
                <p className="text-base sm:text-lg md:text-2xl lg:text-3xl mb-6 sm:mb-8 md:mb-12 font-light text-[#475063]">
                  Uninterrupted power with intelligent solar control.
                </p>
              ...
              <div className="flex justify-center items-center order-first md:order-last">
                <img 
                  ...
                  alt="Sparkle Series Hybrid Solar Inverter" 
      ...
      {/* 4. USE CASE */}
      <section className="relative py-32 md:py-40 bg-zinc-50 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="max-w-2xl">
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-[#0B0D10]">
              Seamless power.<br />Even during outages.
            </h2>
            <div className="space-y-4 text-lg text-[#475063]">
              <p>✓ Residential homes</p>
              <p>✓ Small offices</p>
              <p>✓ Retail shops</p>
              <p>✓ Critical backup locations</p>
            </div>
          </div>
        </div>
      </section>
