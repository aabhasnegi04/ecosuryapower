        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-16 md:gap-20">
            <div className="text-center">
              <div className="text-5xl md:text-6xl font-bold text-green-600 leading-tight">5kVA</div>
              <div className="text-2xl text-zinc-400 my-1">—</div>
              <div className="text-5xl md:text-6xl font-bold text-green-600 leading-tight mb-4">150kVA</div>
              <div className="text-xs uppercase tracking-widest text-zinc-500">Range</div>
            </div>
            <div className="text-center">
              <div className="text-6xl md:text-7xl font-bold text-green-600 leading-tight">Bi</div>
              <div className="text-3xl md:text-4xl font-bold text-green-600 mb-4">Directional</div>
              <div className="text-xs uppercase tracking-widest text-zinc-500">Inverter</div>
            </div>
            <div className="text-center">
              <div className="text-6xl md:text-7xl font-bold text-green-600 leading-none mb-4">IGBT</div>
              <div className="text-xs uppercase tracking-widest text-zinc-500">Rectifier</div>
            </div>
            <div className="text-center">
              <div className="text-6xl md:text-7xl font-bold text-green-600 leading-none mb-4">DSP</div>
              <div className="text-xs uppercase tracking-widest text-zinc-500">Multiple</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-12 lg:px-20">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-8">
              <h3 className="text-2xl font-bold mb-3 text-[#0B0D10]">Bidirectional Inverter</h3>
            ...
            <div className="bg-white p-8">
              <h3 className="text-2xl font-bold mb-3 text-[#0B0D10]">Flexibility in Design</h3>
              <p className="text-[#475063] leading-relaxed">
            ...
            <div className="bg-white p-8">
              <h3 className="text-2xl font-bold mb-3 text-[#0B0D10]">Grid Utilization</h3>
              <p className="text-[#475063] leading-relaxed">
            ...
            <div className="bg-white p-8">
              <h3 className="text-2xl font-bold mb-3 text-[#0B0D10]">Battery-Less Operation</h3>
              <p className="text-[#475063] leading-relaxed">
            ...
            <div className="bg-white p-8">
              <h3 className="text-2xl font-bold mb-3 text-[#0B0D10]">IGBT Based Rectifier</h3>
              <p className="text-[#475063] leading-relaxed">
            ...
            <div className="bg-white p-8">
              <h3 className="text-2xl font-bold mb-3 text-[#0B0D10]">Multiple DSP Control</h3>
              <p className="text-[#475063] leading-relaxed">
