export default function EnergyStorageSystems() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#e5e9ea' }}>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-16 md:gap-20">
            <div className="text-center">
              <div className="text-5xl md:text-6xl font-bold text-green-600 leading-tight">4.8kW</div>
              <div className="text-2xl text-zinc-400 my-1">|</div>
              <div className="text-5xl md:text-6xl font-bold text-green-600 leading-tight mb-4">100kW</div>
              <div className="text-xs uppercase tracking-widest text-zinc-500">Capacity</div>
            </div>
            <div className="text-center">
              <div className="text-6xl md:text-7xl font-bold text-green-600 leading-none mb-4">Li-ion</div>
              <div className="text-xs uppercase tracking-widest text-zinc-500">Technology</div>
            </div>
            <div className="text-center">
              <div className="text-6xl md:text-7xl font-bold text-green-600 leading-none mb-4">Fast</div>
      ...
      {/* 3. KEY FEATURES */}
      <section className="py-24 md:py-32" style={{ backgroundColor: '#e5e9ea' }}>
        <div className="max-w-6xl mx-auto px-6 md:px-12 lg:px-20">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-8">
              <h3 className="text-2xl font-bold mb-3 text-[#0B0D10]">Smoke Free</h3>
            ...
            <div className="bg-white p-8">
              <h3 className="text-2xl font-bold mb-3 text-[#0B0D10]">Genset Alternative</h3>
              <p className="text-[#475063] leading-relaxed">
            ...
            <div className="bg-white p-8">
              <h3 className="text-2xl font-bold mb-3 text-[#0B0D10]">Long Life</h3>
              <p className="text-[#475063] leading-relaxed">
            ...
            <div className="bg-white p-8">
              <h3 className="text-2xl font-bold mb-3 text-[#0B0D10]">High Performance</h3>
              <p className="text-[#475063] leading-relaxed">
            ...
            <div className="bg-white p-8">
              <h3 className="text-2xl font-bold mb-3 text-[#0B0D10]">Mobile Monitoring</h3>
              <p className="text-[#475063] leading-relaxed">
