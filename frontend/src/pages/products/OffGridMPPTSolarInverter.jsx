        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight">
              Engineered for Maximum Solar Efficiency
            </h2>
            <p className="mt-5 text-lg text-gray-600">
              Built with advanced MPPT technology for superior solar energy extraction and intelligent power management.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Scalable systems for residential & commercial applications."
              },
              {
                value: "True MPPT",
                label: "Maximum Power Tracking",
                desc: "Extract 20-30% more energy from your solar panels."
              },
              {
                value: "IoT Enabled",
              ...
              },
              {
                ...
                desc: "Digital signal processing for optimal performance."
              }
            ].map((item, index) => (
              <div
                key={index}
          ...
          <div className="hidden lg:flex items-center justify-center relative min-h-[600px]">
            ...
            <div className="relative z-10 bg-gradient-to-b from-[#162B4F] to-[#101D34] p-16 rounded-3xl shadow-[0_80px_140px_rgba(0,0,0,0.85)] border border-white/10 hover:scale-[1.01] transition duration-500 ease-out">
              <div className="bg-[#F4F6F8] p-8 rounded-2xl shadow-inner">
                <img 
                  src="/products/off-grid-pmmt-solar-inverter.png" 
                  alt="Off-Grid MPPT Solar Inverter" 
            ...
            <div className="absolute left-0 space-y-20 z-20 -translate-x-32">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="text-xl font-semibold tracking-wide">True MPPT</h4>
                  <p className="text-sm text-white/50 mt-1">Maximum power extraction</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                <div className="w-28 h-[1px] bg-gradient-to-r from-white/10 via-white/30 to-white/60"></div>
                <div>
                  <h4 className="text-xl font-semibold tracking-wide">AI Charge Sharing</h4>
                  <p className="text-sm text-white/50 mt-1">Intelligent distribution</p>
                </div>
              </div>
            ...
            <div className="absolute right-0 space-y-20 z-20 translate-x-32">
              ...
              <div className="flex items-center gap-4 justify-end">
                <div className="text-right">
                  <h4 className="text-xl font-semibold tracking-wide">Configurable Settings</h4>
                  <p className="text-sm text-white/50 mt-1">Customizable parameters</p>
                </div>
          ...
          <div className="lg:hidden">
            ...
            <div className="mt-12 space-y-8 px-6 text-center max-w-md mx-auto">
              ...
              <div className="bg-white/5 rounded-xl p-5 border-l-2 border-white/20">
                <h4 className="text-lg font-semibold tracking-wide">True MPPT</h4>
                <p className="text-white/60 text-sm mt-1">Extract 20-30% more energy</p>
              </div>
              
              <div className="bg-white/5 rounded-xl p-5 border-l-2 border-white/20">
                <h4 className="text-lg font-semibold tracking-wide">Configurable Settings</h4>
                <p className="text-white/60 text-sm mt-1">Customize for your needs</p>
              </div>
              
              <div className="bg-white/5 rounded-xl p-5 border-l-2 border-white/20">
                <h4 className="text-lg font-semibold tracking-wide">AI Charge Sharing</h4>
                <p className="text-white/60 text-sm mt-1">Intelligent load distribution</p>
              </div>
              
              <div className="bg-white/5 rounded-xl p-5 border-l-2 border-white/20">
                <h4 className="text-lg font-semibold tracking-wide">Remote Monitoring</h4>
                <p className="text-white/60 text-sm mt-1">IoT-enabled control</p>
              </div>
