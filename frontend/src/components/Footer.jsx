      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-10 md:gap-12 mb-10 md:mb-12">
          ...
          <div className="md:col-span-1">
            <img src="/eco_surya_logo.png" alt="EcoSuryaPower" className="h-20 md:h-24 w-auto mb-4" />
        ...
        <div className="pt-8 border-t border-zinc-800 flex flex-col md:flex-row justify-between items-center gap-4 text-zinc-500 text-sm">
          <p>&copy; 2026 EcoSuryaPower. All rights reserved.</p>
          <div className="flex items-center gap-5">
            <a href="https://www.instagram.com/ecosuryapower" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Instagram">
            ...
            <a href="https://www.facebook.com/ecosuryapower" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Facebook">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
